...
import { Col, Container, Nav, Navbar, Offcanvas, Row, Button } from "react-bootstrap";
          ...
          <Container fluid>
            <Row className="w-100 align-items-center position-relative">
              ...
              <Col xs={0} className="text-end">
                ...
                <Button variant="transparent" style={{border:'none',height:'50px'}}>User Name <spamn ><CgProfile /></spamn> </Button>
              </Col>
            </Row>
            <Navbar.Offcanvas
